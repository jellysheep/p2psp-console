...
with open("splitter.log") as f:
    for line in f:
        if re.match(r'.+%(monitor)s.+%(nat1_pub)s.+%(nat2_pub)s.+' % addresses, line, re.M | re.I):
...
with open("monitor.log") as f:
    for line in f:
        if re.match(r'.+%(nat1_pub)s.+%(nat2_pub)s.+' % addresses, line, re.M | re.I):
...
with open("peer1.log") as f:
    for line in f:
        if re.match(r'.+%(monitor)s.+%(nat2_pub)s.+' % addresses, line, re.M | re.I):
...
with open("peer2.log") as f:
    for line in f:
        if re.match(r'.+%(monitor)s.+%(nat1_pub)s.+' % addresses, line, re.M | re.I):
