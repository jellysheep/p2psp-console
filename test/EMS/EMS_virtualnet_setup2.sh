...
NAMESPACES="pc1 nat1 splitter monitor nat2 pc2"
...
create_interface_to_bridge monitor ifmonitor $monitor brinet
...
for NAMESPACE in nat1 splitter monitor nat2; do
